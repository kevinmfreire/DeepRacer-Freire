...
class TensorflowModel():
    ...
    def write_frozen_graph(self, sess, agent_name, iteration_id):
        ...
        LOG.info("Running andrei bug fix")
#         if self.action_space_type == 'discrete':    
#             output_head = ['main_level/{}/main/online/network_1/ppo_head_0/policy'.format(agent_name)]
#         elif self.action_space_type == 'continuous':
        output_head = [
                'main_level/{}/main/online/network_1/ppo_head_0/policy_mean/kernel'.format(agent_name),
                'main_level/{}/main/online/network_1/ppo_head_0/policy_mean/bias'.format(agent_name),
                'main_level/{}/main/online/network_1/ppo_head_0/policy_std'.format(agent_name)
            ]  
